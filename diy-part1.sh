...
echo 'src-git small8 https://github.com/teddy780102/small-package' >>feeds.conf.default
echo 'src-git small https://github.com/teddy780102/small' >>feeds.conf.default
